...
public class RoundSunglasses extends AppCompatActivity {

    private static final String TAG = RoundSunglasses.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        roundsunglassesbtn.setEnabled(false);
    ...
    public void goToBrowline() {
        ...
        String message = "browline sunglasses";
        intent.putExtra(intent.EXTRA_TEXT, message);
        startActivity(intent);
    }
