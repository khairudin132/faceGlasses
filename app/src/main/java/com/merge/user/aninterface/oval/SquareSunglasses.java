...
public class SquareSunglasses extends AppCompatActivity {

    private static final String TAG = SquareSunglasses.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        squaresunglassesbtn.setEnabled(false);
    ...
    public void goToVictorrectangular() {
        ...
        String message = "victor rectangular";
        intent.putExtra(intent.EXTRA_TEXT, message);
        startActivity(intent);
    }
