...
public class Wayfarer extends AppCompatActivity {

    private static final String TAG = Wayfarer.class.getSimpleName();
    ...
    public void goToCarlsunglasses() {
        ...
        String message = "carlsunglasses glasses";
        intent.putExtra(intent.EXTRA_TEXT, message);
        startActivity(intent);
    }
