...
public class BulatMuka extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bulat_muka);
        ...
        gmbrMuka = (ImageView)findViewById(R.id.bulat);
        sgd = new ScaleGestureDetector(this, new BulatMuka.ScaleListener());

        roundMask.setEnabled(false);
