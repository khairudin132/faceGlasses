 ...
 * tasks easier.
 */
public class ArFaceSquare extends AppCompatActivity {
    private static final String TAG = ArFaceSquare.class.getSimpleName();
    ...
    private Button round_sunglassesbtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        round_sunglassesbtn = (Button) findViewById(R.id.round_sunglassesbutton);
        ...
        //round_sunglasses
        round_sunglassesbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                roundSunglasses();
            }
    ...
    public void browline() {
        // Load the face regions renderable.
        // This is a skinned model that renders 3D objects mapped to the regions of the augmented face.

        ModelRenderable.builder()
                .setSource(this, R.raw.browline)
                .build()
                .thenAccept(
                        modelRenderable -> {
                            faceRegionsRenderable = modelRenderable;
    ...
    public void roundSunglasses() {
        // Load the face regions renderable.
        // This is a skinned model that renders 3D objects mapped to the regions of the augmented face.

        ModelRenderable.builder()
                .setSource(this, R.raw.round_sunglasses)
                .build()
                .thenAccept(
                        modelRenderable -> {
                            faceRegionsRenderable = modelRenderable;
