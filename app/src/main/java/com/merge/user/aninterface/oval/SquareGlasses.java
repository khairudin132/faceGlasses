...
public class SquareGlasses extends AppCompatActivity {

    private static final String TAG = SquareGlasses.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        squareglassesbtn.setEnabled(false);
