...
public class CatEyeSunglasses extends AppCompatActivity {

    private static final String TAG = CatEyeSunglasses.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cateyesunglassesbtn.setEnabled(false);
    ...
    public void goToSemirimless() {
        ...
        String message = "semirimless sunglasses";
        intent.putExtra(intent.EXTRA_TEXT, message);
        startActivity(intent);
    }
