...
public class RoundMask extends AppCompatActivity {

    private static final String TAG = RoundMask.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ModelRenderable.builder()
                .setSource(this, R.raw.muka_bulat1)
                .build()
                .thenAccept(
                        modelRenderable -> {
    ...
    public void goToOvalMask() {
        Intent intent = new Intent(this, OvalMask.class);
