...
public class VictorRectangular extends AppCompatActivity {

    private static final String TAG = VictorRectangular.class.getSimpleName();
    ...
    public void goToSemirimless() {
        ...
        String message = "semirimless rectangular glasses";
        intent.putExtra(intent.EXTRA_TEXT, message);
        startActivity(intent);
    }
